			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navegacion-fm">
					<ul class="nav navbar-nav">
						...
						<li><a href="index.php"><span class="glyphicon glyphicon-plus-sign"></span>Registrarse</a></li>						
					</ul>
		...
		<div class="row">
			<div class="col-md-4">
				<form action="index.php" method="post">
					...
					<label for="">Usuario por defecto: admin</label><br>
					<label for="">Clave por defecto: admin</label><br>
